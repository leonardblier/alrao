...
class Corpus(object):
    def __init__(self, path, char_prediction = False):
        ...
        self.build_dict(os.path.join(path, 'train.txt'), char_prediction)
        self.build_dict(os.path.join(path, 'valid.txt'), char_prediction)
        self.build_dict(os.path.join(path, 'test.txt'), char_prediction)
    ...
    def build_dict(self, path, char_prediction = False):
